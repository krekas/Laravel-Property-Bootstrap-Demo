<template>
		<div class="property-item">
				<Link :href="route('properties.show', property)" class="img">
						<img :src="'/' + property.images[0].image" alt="Image" class="img-fluid" />>
				</Link>

				<div class="property-content">
						<div class="price mb-2"><span>${{ property.price.toFixed(2) }}</span></div>
						<div>
