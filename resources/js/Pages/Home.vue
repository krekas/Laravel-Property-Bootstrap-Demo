          ...
          <div class="col-12">
            <div class="property-slider-wrap">
              <div class="property-slider">
									<Property v-for="property in properties" :key="property.id" :property="property" />
              </div>
          ...
          <div class="testimonial-slider">
							<div class="item" v-for="testimonial in testimonials">
									<div class="testimonial">
											...
											/>
											<div class="rate">
													<span class="icon-star text-warning" v-for="n in testimonial.rating"></span>
											</div>
    ...
    <div class="section section-5 bg-light">
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          ...
          <div class="row">
							<div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" v-for="agent in agents">
